...
const GridMinimap = ({
  ...
  return (
    <div
      ref={minimapRef}
      className="absolute bottom-2 left-[calc(var(--dmn-grid-controls-left,0px)+0.5rem)] z-[var(--z-chrome-panel)] select-none bg-glass-dim backdrop-glass-popup backdrop-glass-canvas rounded-[8px] shadow-elevation-chrome overflow-hidden"
