...
const COMPILED = [
  'packages/editor/src/renderer/components/main/Grid/PropertiesPanel/single/SingleSpritePanel.tsx',
  'packages/editor/src/renderer/components/main/Modal/content/pickers/ImagePicker.tsx',
];
...
describe('스프라이트 편집 컴파일러 가드', () => {
  ...
  it("SpriteCanvasHandles는 'use no memo'로 제외를 명시한다", () => {
    const path =
      'packages/editor/src/renderer/components/main/Grid/handles/SpriteCanvasHandles.tsx';
