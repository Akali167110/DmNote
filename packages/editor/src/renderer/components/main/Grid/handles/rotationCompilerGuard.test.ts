...
const COMPILED = [
  'packages/editor/src/renderer/components/main/Grid/handles/CanvasRotateHandle.tsx',
  'packages/editor/src/renderer/components/main/Grid/PropertiesPanel/batch/geometry/SelectionRotationInput.tsx',
];
...
describe('요소 회전 컴파일러 가드', () => {
  ...
  it("useSelectionRotationFrame은 'use no memo'로 제외를 명시한다", () => {
    const path =
      'packages/editor/src/renderer/hooks/Grid/selection/useSelectionRotationFrame.ts';
