...
const implementationCommit = execFileSync(
  ...
  [
    ...
    '--format=%H',
    '--',
    'packages/editor/src/renderer/components/main/Modal/floatingPopup/FloatingPopup.tsx',
    'packages/editor/src/renderer/components/main/Modal/listPopup/ListPopup.tsx',
  ],
...
const correctnessResult = spawnSync(
  ...
  [
    'vitest',
    'run',
    'packages/editor/src/renderer/components/main/Modal/floatingPopup/FloatingPopup.test.tsx',
    'packages/editor/src/renderer/components/main/Modal/listPopup/ListPopup.test.tsx',
    'packages/editor/src/renderer/__tests__/popup/floatingPopupLayerOwnership.test.tsx',
  ],
