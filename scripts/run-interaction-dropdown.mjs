...
const implementationCommit = execFileSync(
  ...
  [
    ...
    '--format=%H',
    '--',
    'packages/editor/src/renderer/components/main/common/dropdown/Dropdown.tsx',
  ],
...
const correctnessResult = spawnSync(
  ...
  [
    'vitest',
    'run',
    'packages/editor/src/renderer/components/main/common/dropdown/Dropdown.test.tsx',
  ],
