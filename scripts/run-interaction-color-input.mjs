...
const correctnessResult = spawnSync(
  ...
  [
    ...
    'packages/editor/src/renderer/__tests__/panel/activeStatePickerCapability.test.tsx',
    'packages/editor/src/renderer/__tests__/panel/singleActiveStateCapability.test.tsx',
  ],
