...
const correctness = spawnSync(
  ...
  [
    'vitest',
    'run',
    'packages/editor/src/renderer/components/main/Grid/PropertiesPanel/navigation/PanelToggleButton.test.tsx',
    'packages/editor/src/renderer/hooks/useOptimisticCommit.childWindow.test.tsx',
  ],
