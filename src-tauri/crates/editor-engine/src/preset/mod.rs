...
pub use crate::models::BUILTIN_TAB_IDS;
use crate::models::{
...
pub const PRESET_LOCAL_IMAGE_PREFIX: &str = "dmnote-local-image://";
pub const PRESET_LOCAL_SOUND_PREFIX: &str = "dmnote-local-sound://";
pub fn decode_image_data_url(value: &str) -> Option<(Vec<u8>, String)> {
...
pub fn normalize_sound_extension(extension: Option<&str>) -> String {
    match extension
        .unwrap_or_default()
        .trim()
        .to_ascii_lowercase()
...
pub fn normalize_font_extension(extension: Option<&str>) -> String {
    match extension
        .unwrap_or_default()
        .trim()
        .to_ascii_lowercase()
...
pub fn local_source_path_from_image_ref(value: &str) -> Option<PathBuf> {
...
pub fn is_remote_or_virtual_image_ref(value: &str) -> bool {
...
pub fn option_has_non_empty_text(value: &Option<String>) -> bool {
    value
        .as_ref()
