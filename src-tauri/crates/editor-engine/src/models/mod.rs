...
// 테스트 기대값 조립에서만 참조
#[cfg(test)]
pub use element_positions::default_sprite_transition_easing;
pub use element_positions::{
...
pub use key_position_normalization::{
...
impl GradientSpec {
    pub fn from_canonical_parts(angle: f64, stops: Vec<GradientStop>) -> Self {
    ...
    pub fn note_border_invalid_stop_index(&self) -> Option<usize> {
...
pub fn default_angle_mode() -> String {
