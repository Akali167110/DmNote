...
#[serde(rename_all = "camelCase")]
pub struct SpritePosePatchPresence {
    pivot: bool,
    image_override: bool,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct SpritePositionPatchPresence {
    rotation: bool,
    base_image: bool,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
#[serde(transparent)]
pub struct SpritePositionsPatchPresence(HashMap<String, Vec<SpritePositionPatchPresence>>);
...
pub struct EditorPatchV1 {
    ...
    #[serde(skip)]
    pub sprite_positions_presence: Option<SpritePositionsPatchPresence>,
}
...
impl EditorPatchV1 {
    ...
    pub fn merge_omitted_sprite_fields(&mut self, current: &SpritePositions) {
...
impl EditorPaintGradientV1 {
    pub fn to_gradient_spec(&self) -> GradientSpec {
...
impl EditorOpV1 {
    pub fn may_change_keys(&self) -> bool {
        match self {
...
impl EditorFrozenElementV1 {
    ...
    pub fn key_position_mut(&mut self) -> Option<&mut KeyPosition> {
        match self {
...
pub struct CommittedEditorChange {
    ...
    pub plugin_instances_changes: Vec<super::PluginInstancesChangedPayload>,
