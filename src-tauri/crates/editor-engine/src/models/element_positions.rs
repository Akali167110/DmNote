...
pub fn is_renderable_image_ref(value: Option<&str>) -> bool {
    value.is_some_and(|value| !value.trim().is_empty())
}

pub trait CoupledSpriteImageReference {
...
pub fn rewrite_coupled_sprite_image_reference<T, R>(
    target: &mut T,
...
pub fn default_sprite_press_duration_ms() -> u32 {
    300
}
...
pub fn default_sprite_transition_ms() -> u32 {
    0
}

pub fn default_sprite_transition_easing() -> String {
