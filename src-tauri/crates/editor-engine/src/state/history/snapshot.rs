...
impl HistoryDirection {
    pub fn empty_error(self) -> &'static str {
        match self {
...
#[serde(rename_all = "camelCase")]
pub struct CustomTabsHistorySnapshot {
    ...
    pub tab_css_patch: HashMap<String, Option<TabCss>>,
    pub tab_note_patch: HashMap<String, Option<TabNoteSettings>>,
    pub plugin_instances_patch: HashMap<String, Option<Value>>,
}

impl CustomTabsHistorySnapshot {
    pub fn from_transition(before: &AppStoreData, after: &AppStoreData) -> Self {
        Self {
    ...
    pub fn from_store_for_target(store: &AppStoreData, target: &Self) -> Self {
        Self {
    ...
    pub fn matches_store(&self, store: &AppStoreData) -> bool {
    ...
    pub fn apply_override_patches(&self, store: &mut AppStoreData) {
    ...
    pub fn changed_plugin_ids(&self) -> Vec<String> {
...
#[derive(Debug, Clone, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct PresetHistorySettingsSnapshot {
...
#[derive(Debug, Clone, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct PresetFullHistorySnapshot {
    pub document: EditorDocumentV1,
    pub custom_tabs: Vec<CustomTab>,
    pub tab_order: Vec<String>,
    pub bar_count: u8,
    pub selected_key_type: String,
    pub key_counters: KeyCounters,
    pub settings: PresetHistorySettingsSnapshot,
    pub tab_css_overrides: TabCssOverrides,
}

#[derive(Debug, Clone, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct PluginElementsHistorySnapshot {
    pub plugin_id: String,
    pub instances: Option<Vec<SavedPluginInstance>>,
}
