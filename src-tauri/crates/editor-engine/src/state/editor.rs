...
pub use limits::{validate_editor_op_bounds, validate_editor_op_target_type};
...
pub const MAX_SAFE_WIRE_REVISION: u64 = 9_007_199_254_740_991;
pub const MUTATION_ACK_CAPACITY: usize = 32;
pub const MAX_CUSTOM_TABS: usize = 30;
pub const MAX_SLOTS_PER_MEMBER: usize = 16;
...
pub const MAX_EDITOR_OPS: usize = 4_096;
...
pub const MAX_ABS_COORDINATE: f64 = 32_768.0;
pub const MAX_DIMENSION: f64 = 32_768.0;
use crate::models::{
...
pub fn is_valid_gesture_id(gesture_id: &str) -> bool {
...
pub fn is_valid_group_id_shape(group_id: &str) -> bool {
    !group_id.is_empty() && group_id.len() <= MAX_GROUP_ID_BYTES
}

pub fn validate_paired_update(
...
pub fn sync_key_counters(counters: &mut KeyCounters, keys: &KeyMappings) {
...
pub fn repair_selected_mode(store: &mut AppStoreData) {
...
pub fn touched_pair(fields: &[EditorField]) -> (bool, bool) {
    (
