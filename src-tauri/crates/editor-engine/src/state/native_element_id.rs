...
pub use v1_adapter::{prepare_commit_patch_element_ids, validate_document_element_ids};

pub const INVALID_ELEMENT_ID: &str = "INVALID_ELEMENT_ID";
pub const MISSING_ELEMENT_ID: &str = "MISSING_ELEMENT_ID";
pub const DUPLICATE_ELEMENT_ID: &str = "DUPLICATE_ELEMENT_ID";
...
pub fn new_unique_id(reserved: &mut HashSet<String>) -> String {
    loop {
...
pub fn backfill_store_element_ids(store: &mut AppStoreData) -> BackfillOutcome {
...
pub fn rekey_store_element_ids(store: &mut AppStoreData) {
    let mut reserved = collect_store_ids(store);
...
pub fn rekey_mode_element_ids(store: &mut AppStoreData, mode: &str) {
    rekey_mode_element_ids_for_collections(store, mode, true, true, true, true, true);
}

pub fn rekey_mode_element_ids_for_collections(
...
pub fn backfill_mode_element_ids_for_collections(
    store: &mut AppStoreData,
    mode: &str,
    key_positions: bool,
    stat_positions: bool,
