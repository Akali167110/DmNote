...
pub fn repair_legacy_state(mut value: Value) -> AppStoreData {
...
pub fn repair_custom_tab_key_layout_pairs(
...
pub fn recover_collection_field(field: &str, value: &Value) -> Option<Value> {
    match field {
...
pub fn recover_key_mapping_entries(value: &Value) -> Option<Value> {
...
pub fn recover_sound_library_entries(value: &Value) -> Option<Value> {
...
pub fn recover_local_font_enabled(value: &Value) -> Option<Value> {
    let Value::Object(source) = value else {
        return None;
    };
