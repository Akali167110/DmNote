...
pub fn default_store_note_gradient_multipliers(value: &mut Value) -> bool {
...
pub fn has_explicit_invalid_element_id(value: &Value) -> bool {
...
pub fn migrate_sound_library_enabled(value: &mut Value) -> bool {
...
pub fn migrate_legacy_sprite_wire(value: &mut Value) -> bool {
...
pub fn migrate_legacy_sprite_positions_value(value: &mut Value) -> bool {
...
pub fn migrate_legacy_knob_sensitivity(data: &mut AppStoreData) -> bool {
...
pub fn repair_semantic_identities(data: &mut AppStoreData) -> bool {
    let mut changed = false;
...
pub fn rgba_to_hex(color: &str) -> Option<String> {
...
pub fn has_convertible_note_border_color(data: &AppStoreData) -> bool {
...
pub fn normalize_state(mut data: AppStoreData) -> AppStoreData {
...
pub fn normalize_sprite_triggers(data: &mut AppStoreData) -> bool {
    let mut changed = false;
...
pub fn repair_sprite_numeric_ranges(data: &mut AppStoreData) -> bool {
...
pub fn repair_native_position_ranges(data: &mut AppStoreData) -> bool {
...
pub fn has_legacy_font_weight_state(data: &AppStoreData) -> bool {
    data.key_positions
        .values()
        .flatten()
        .chain(
...
pub fn migrate_legacy_font_weight_state(data: &mut AppStoreData) -> bool {
    let mut changed = false;
    for position in data.key_positions.values_mut().flatten() {
...
pub fn normalize_blank_font_colors(data: &mut AppStoreData) -> bool {
...
pub fn canonicalize_image_modes(data: &mut AppStoreData) -> bool {
    let mut changed = false;
    for position in data.key_positions.values_mut().flatten() {
...
pub fn remove_legacy_panel_detach_setting(data: &mut AppStoreData) -> bool {
    data.plugin_data
        .remove(LEGACY_PANEL_DETACH_ENABLED_KEY)
        .is_some()
}

pub fn canonicalize_gradient_pairs(data: &mut AppStoreData) -> (bool, bool) {
    let mut changed = false;
...
pub fn repair_editor_revision(data: &mut AppStoreData) -> bool {
...
pub fn has_valid_selected_key_type(data: &AppStoreData) -> bool {
...
pub fn clear_dangling_group_ids(data: &mut AppStoreData) -> bool {
...
pub fn clear_dangling_group_ids_in(
...
/// 인덱스 결합 배열의 길이 보정
pub fn pad_key_position_lengths(keys: &mut KeyMappings, positions: &mut KeyPositions) -> bool {
    let modes = keys
        .keys()
...
pub fn key_position_lengths_mismatch(keys: &KeyMappings, positions: &KeyPositions) -> bool {
    keys.keys()
        .chain(positions.keys())
