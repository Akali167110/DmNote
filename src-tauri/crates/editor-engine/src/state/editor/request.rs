...
pub fn decode_editor_commit_request(
    value: Value,
...
pub fn decode_exact_frozen_insert<T>(value: Value, label: &str) -> Result<T, EditorCommitError>
where
...
pub fn validate_request_envelope(request: &EditorCommitRequest) -> Result<(), EditorCommitError> {
...
pub fn validate_revision(revision: u64) -> Result<(), EditorCommitError> {
...
pub fn next_revision(current: u64) -> Result<u64, EditorCommitError> {
...
pub fn validate_history_restore_metadata(
...
pub fn gesture_request_fingerprint(
...
pub fn request_payload_size(request: &EditorCommitRequest) -> Result<usize, EditorCommitError> {
