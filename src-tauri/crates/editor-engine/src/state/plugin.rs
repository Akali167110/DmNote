...
pub const MAX_PLUGIN_INSTANCES_REQUEST_BYTES: usize = 8 * 1024 * 1024;
// 플러그인 스토리지 키 네임스페이스 - storage 커맨드와 canonical 헬퍼의 단일 원천
pub const PLUGIN_DATA_KEY_PREFIX: &str = "plugin_data_";
...
pub fn validate_plugin_instances_request(
...
pub fn validate_plugin_instances_transition(
...
pub fn validate_plugin_instances_reconcile_request(
...
#[cfg(test)]
pub fn validate_saved_plugin_instances(instances: &[SavedPluginInstance]) -> Result<(), String> {
...
pub fn normalize_plugin_instance_tab_id(tab_id: Option<&str>) -> &str {
...
pub type PluginGroupRefs = HashMap<String, HashSet<String>>;

pub fn add_plugin_group_refs(refs: &mut PluginGroupRefs, instances: &[SavedPluginInstance]) {
...
pub fn for_each_stored_plugin_instances(
    data: &AppStoreData,
...
pub fn plugin_group_refs_from_store(
    data: &AppStoreData,
...
pub fn plugin_instances_storage_key(plugin_id: &str) -> String {
    format!("{PLUGIN_DATA_KEY_PREFIX}{plugin_id}/instances")
}

pub fn plugin_id_from_instances_storage_key(key: &str) -> Option<&str> {
...
pub fn is_plugin_instances_storage_key(key: &str) -> bool {
    plugin_id_from_instances_storage_key(key).is_some()
}

#[derive(Debug)]
pub enum StoredPluginInstanceEntry {
    Parsed {
...
pub fn decode_plugin_instance_entries(
    value: &Value,
    storage_key: &str,
...
pub fn encode_plugin_instance_entries(
...
pub fn backfill_plugin_instance_ids(data: &mut AppStoreData) -> BackfillOutcome {
...
#[cfg(test)]
pub fn decode_plugin_instances(
    value: Option<&Value>,
...
pub fn decode_plugin_instances_lenient(
    value: Option<&Value>,
    storage_key: &str,
...
pub fn encode_plugin_instances(instances: &[SavedPluginInstance]) -> Result<Option<Value>, String> {
