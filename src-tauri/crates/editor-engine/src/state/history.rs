...
pub const HISTORY_ENTRY_MAX_BYTES: usize = 8 * 1024 * 1024;
...
pub const HISTORY_IN_PROGRESS: &str = "HISTORY_IN_PROGRESS";
pub const HISTORY_ENTRY_TOO_LARGE: &str = "HISTORY_ENTRY_TOO_LARGE";
pub const INVALID_HISTORY_OPERATION_ID: &str = "INVALID_HISTORY_OPERATION_ID";
pub const HISTORY_OPERATION_ID_REUSED: &str = "HISTORY_OPERATION_ID_REUSED";
pub const HISTORY_SCOPE_MISMATCH: &str = "HISTORY_SCOPE_MISMATCH";
pub const HISTORY_TARGET_ALREADY_APPLIED: &str = "HISTORY_TARGET_ALREADY_APPLIED";
pub const HISTORY_INVALID_OPPOSITE_ENTRY: &str = "HISTORY_INVALID_OPPOSITE_ENTRY";
...
impl HistoryService {
    ...
    pub fn status(&self, admission_closed: bool) -> HistoryStatus {
        HistoryStatus {
    ...
    pub fn issue_status(&mut self, admission_closed: bool) -> HistoryStatus {
    ...
    pub fn prepare_entry_with_gesture_ids(
        &self,
        changed_fields: Vec<EditorField>,
        before: EditorPatchV1,
    ...
    pub fn prepare_opposite_editor_entry(
        &self,
        changed_fields: Vec<EditorField>,
        before: EditorPatchV1,
        key_counters: Option<KeyCounters>,
    ...
    pub fn prepare_custom_tabs_entry(
        &self,
    ...
    pub fn prepare_mode_entry(&self, before: String) -> Result<HistoryRecordPlan, String> {
        self.prepare_snapshot(
            HistoryScope::Mode,
    ...
    pub fn prepare_counters_entry(&self, before: KeyCounters) -> Result<HistoryRecordPlan, String> {
        self.prepare_snapshot(
    ...
    pub fn prepare_preset_full_entry(
        &self,
    ...
    pub fn prepare_plugin_elements_entry(
        &self,
    ...
    pub fn prepare_opposite_plugin_elements_entry(
        &self,
        before: PluginElementsHistorySnapshot,
    ) -> Result<HistoryRecordPlan, String> {
        self.prepare_snapshot(
    ...
    pub fn prepare_opposite_compound_entry(
        &self,
    ...
    pub fn apply_record_plan(&mut self, plan: HistoryRecordPlan) {
    ...
    pub fn apply_editor_record_plan(
        &mut self,
    ...
    pub fn apply_plugin_elements_record_plan(
        &mut self,
        mut plan: HistoryRecordPlan,
    ...
    pub fn invalidate_future(&mut self) -> bool {
    ...
    pub fn contains_plugin_elements_for(&self, plugin_id: Option<&str>) -> bool {
        self.past
            .iter()
