...
pub const MIN_BAR_SLOTS: u8 = 1;
pub const MAX_BAR_SLOTS: u8 = 4;

pub fn normalize_tab_order(order: &[String], custom_tabs: &[CustomTab]) -> Vec<String> {
...
pub fn normalize_bar_count(bar_count: u8, tab_order: &[String]) -> u8 {
...
pub fn legacy_tab_order(custom_tabs: &[CustomTab]) -> Vec<String> {
    BUILTIN_TAB_IDS
        .iter()
        .map(|id| (*id).to_string())
...
pub fn reconcile_custom_tab_metadata(
...
pub fn validate_custom_tab_name(
    name: &str,
