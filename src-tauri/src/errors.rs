...
pub use dmnote_editor_engine::errors::*;
...
mod tests {
    ...
    const EDITOR_SOURCE: &str = include_str!("../crates/editor-engine/src/state/editor.rs");
    const EDITOR_LIMITS_SOURCE: &str =
        include_str!("../crates/editor-engine/src/state/editor/limits.rs");
    const PLUGIN_SOURCE: &str = include_str!("../crates/editor-engine/src/state/plugin.rs");
