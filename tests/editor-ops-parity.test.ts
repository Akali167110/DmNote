...
import { EDITOR_OPS_VERSION } from '../packages/editor/src/types/editor';
import {
  createEditorCoordinator,
  getChangedEditorFields,
} from '../packages/editor/src/renderer/editor/runtime/coordinator/editorCoordinator';
...
import type { EditorCoordinatorTransport } from '../packages/editor/src/renderer/editor/runtime/coordinator/editorCoordinator';
